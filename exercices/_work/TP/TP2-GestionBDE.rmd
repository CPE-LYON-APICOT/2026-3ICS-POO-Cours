...
public class Adherent {
    ...
    public String toString() {
        ...
        return prenom + " " + nom + " (" + promotion + ") - " + statut;
    }
}
```
...
public class Boutique {
    ...
    public double vendre(Achetable achat, Adherent acheteur) {
        ...
        // Appliquer réduction adhérent sur les articles
        if (achat instanceof Article && acheteur.isCotisationPayee()) {
            if (acheteur instanceof MembreBureau) {
                prix *= 0.5; // -50%
            } else {
                prix *= 0.9; // -10%
            }
