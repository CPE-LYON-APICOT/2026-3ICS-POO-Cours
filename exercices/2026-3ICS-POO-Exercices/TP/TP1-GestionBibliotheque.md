...
> **Indice** **héritage** ou **composition** avec des **stratégies** peut résoudre ce problème. Chaque type d'adhérent peut avoir sa propre logique de vérification. Les **strategies** sont un type de design pattern, vous les verrez plus tard dans le cours.
...
> **Indice** DP **Observer** ou d'utiliser des **événements** pour découpler la logique métier de la logique de notification. A priori vous ne devriez pas encore connaitre cette manière de faire mais vous pouvez essayer !
